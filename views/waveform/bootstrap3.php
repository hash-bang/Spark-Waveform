...
$this->waveform->Style('table_row_err', array('class' => 'form-group has-error'));
...
$this->waveform->Style('table_input_err', array('SUFFIX' => '<span class="help-inline text-danger">{$errs}</span>'));
